                    ...
                    <BookDetailPanel
                        ...
                        actions={
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-[#C9A063]/40 bg-[#C9A063]/20 text-[#F0D5A3] font-medium text-xs hover:bg-[#C9A063]/30 hover:border-[#C9A063]/60 hover:text-white transition-[border-color,background-color,color] duration-150 active:scale-[0.97] cursor-pointer"
                            >
